 ...
 */
class GetAssociatedProducts extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('SimilarProducts_AssociatedProducts');
        $this->dimension     = new ProductName();
        $this->documentation = Piwik::translate('');
        $this->categoryId = 'Goals_Ecommerce';
        $this->subcategoryId ='Similar Products R';
        ...
        // $this->subcategoryId = 'SimilarProducts_AssociatedProducts';
    }
    ...
    {
        $view = new View('@SimilarProducts/getAssociatedProducts');
        $view->myData = array();
